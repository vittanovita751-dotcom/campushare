          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Pemantauan keaktifan transaksi dan keandalan mahasiswa', style: TextStyle(fontSize: 12, color: Colors.grey)),
                          ...
                          return DataRow(
                            cells: [
                              DataCell(
                                CircleAvatar(
                                  radius: 12,
                                  backgroundColor: rank <= 3 ? const Color(0xFF64B5F6).withOpacity(0.15) : Colors.grey.shade100,
                                  child: Text(
                                    '$rank',
                                    style: TextStyle(
                                      fontSize: 12,
