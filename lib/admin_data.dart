...
class AdminState extends ChangeNotifier {
  ...
  void _initializeMockData() {
    ...
    // Items
    items.addAll([
      AdminItem(id: 1, name: 'Proyektor Epson EB-X06', category: 'Proyektor', owner: 'Novita Sari', location: 'Fasilkom Lab A', status: 'Tersedia', imageUrl: 'https://images.unsplash.com/photo-1535016120720-40c646be5580?w=150'),
      AdminItem(id: 2, name: 'Kamera DSLR Canon EOS 3000D', category: 'Kendaraan', owner: 'Budi Raharjo', location: 'Selasar Teknik', status: 'Dipinjam', imageUrl: 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=150'),
      AdminItem(id: 3, name: 'Kabel HDMI Vention 5 Meter', category: 'Kabel HDMI', owner: 'Aditya Pratama', location: 'Kost Pondok Hijau', status: 'Tersedia', imageUrl: 'https://images.unsplash.com/photo-1557672172-298e090bd0f1?w=150'),
      AdminItem(id: 4, name: 'Jas Laboratorium Kimia Ukuran L', category: 'Jas Laboratorium', owner: 'Siti Aminah', location: 'Lab Kimia Dasar', status: 'Tersedia', imageUrl: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=150'),
      AdminItem(id: 5, name: 'Laptop Dell Inspiron 15', category: 'Laptop', owner: 'Rani Wijaya', location: 'Kost Lavender B3', status: 'Tersedia', imageUrl: 'https://images.unsplash.com/photo-1496181130204-755241524eab?w=150'),
      AdminItem(id: 6, name: 'Kalkulator Casio fx-991EX', category: 'Buku', owner: 'Novita Sari', location: 'Fasilkom Perpustakaan', status: 'Bermasalah', imageUrl: 'https://images.unsplash.com/photo-1629654297299-c8506221ca97?w=150'),
      AdminItem(id: 7, name: 'Honda Beat FI 2019', category: 'Kendaraan', owner: 'Budi Raharjo', location: 'Parkir FT', status: 'Dipinjam', imageUrl: 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=150'),
    ]);
  ...
  void toggleItemProblematic(int id) {
    ...
    if (idx != -1) {
      items[idx].status = items[idx].status == 'Bermasalah' ? 'Tersedia' : 'Bermasalah';
      notifyListeners();
    }
  }
